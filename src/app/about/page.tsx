...
export default function About() {
  const structure = [
    ...
    },
    {
      ...
      items: about.highlights.items.map((item) => item.title),
    },
    {
        ...
        {about.avatar.display && (
          ...
          >
            ...
            <Row gap="8" vertical="center">
              ...
              <LocalizedText en={person.location.split("/").pop()} tr="İstanbul" />
            </Row>
            ...
            <>
              ...
              <Column fillWidth gap="l" marginBottom="40">
                {about.highlights.items.map((item) => (
                  <Column key={item.title} id={item.title} fillWidth gap="8" className={styles.highlightCard}>
                ...
                {about.technical.skills.map((skill, index) => (
                  <Column key={`${skill}-${index}`} fillWidth gap="4">
                    <Text id={skill.title} variant="heading-strong-l">
                      <LocalizedText
                        en={skill.title}
                        tr={skill.title === "Programming & Application Development"
