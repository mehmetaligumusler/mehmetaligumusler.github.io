 ...
 * @description Configuration for the interactive CV page, including metadata and navigation label.
 *              The CV content itself is reused from the About page sections (work, studies, highlights, technical).
 */
